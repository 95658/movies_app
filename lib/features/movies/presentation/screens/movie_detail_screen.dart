...
import 'package:movies_app/features/movies/domain/entities/geners.dart';
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Container(
                                ...
                                child: Text(
                                  state.movieDetails!.relaseDate.split('-')[0],
                          ...
                          const SizedBox(height: 8.0),
                          Text(
                            'Genres: ${_showGenres(state.movieDetails!.geners)}',
                            style: const TextStyle(
                              color: Colors.white70,
                              fontSize: 12.0,
                              fontWeight: FontWeight.w500,
